...
export default function WelcomeCard({ userName, userType, onClose }: WelcomeCardProps) {
  return (
    <AnimatePresence>
      <motion.div
        className="fixed top-20 right-4 bg-white border border-gray-200 shadow-lg rounded-lg p-6 max-w-sm z-50"
